            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="{{ route('admin.inventory.low-stock') }}" class="btn btn-sm btn-warning">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="text" name="search" class="form-control" placeholder="Search by product name or brand" value="{{ request('search') }}">
