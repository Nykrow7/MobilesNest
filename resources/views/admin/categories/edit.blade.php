    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <h2 class="text-2xl font-bold mb-4">Edit Category: {{ $category->name }}</h2>
                ...
                <form method="POST" action="{{ route('admin.categories.update', $category) }}" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div>
                        <x-input-label for="image" value="Category Image (Leave empty to keep current image)" />
                        ...
                        <div class="mt-2">
                            ...
                            <img src="{{ asset('storage/' . $category->image) }}" alt="{{ $category->name }}" class="mt-1 h-32 w-auto object-cover rounded">
                        </div>
                        @endif
                    </div>
