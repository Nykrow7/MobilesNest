        ...
        <div class="md:w-2/3">
            ...
            <form action="{{ route('transactions.process', $order) }}" method="POST" id="payment-form">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <button type="submit" class="bg-green-600 hover:bg-green-700 text-black font-bold py-3 px-6 rounded-md transition-colors duration-200 flex items-center shadow-lg">
                        ...
                        <span class="text-black text-lg">Complete Payment</span>
                    </button>
                </div>
            </form>
        </div>
        ...
        paymentForm.addEventListener('submit', function(e) {
            ...
            loadingOverlay.innerHTML = `
                <div class="bg-white p-6 rounded-lg shadow-xl text-center">
                    ...
                    <p class="text-sm text-gray-500 mt-2">Please do not close this page.</p>
                </div>
            `;
