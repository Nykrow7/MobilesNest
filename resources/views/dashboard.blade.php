                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10 bg-gray-200 rounded-md flex items-center justify-center">
                                    @if (isset($item['product']) && $item['product'] && isset($item['product']->primaryImage))
                                        <img src="{{ asset('storage/' . $item['product']->primaryImage->path) }}" alt="{{ $item['product']->name ?? 'Product Image' }}" class="h-10 w-10 object-cover rounded-md">
                                    @else
                                ...
                                <div class="ml-4 flex-1">
                                    <div class="flex justify-between">
                                        <h4 class="text-sm font-medium text-gray-900">{{ $item['product']->name ?? 'Product Not Available' }}</h4>
                                        <p class="text-sm font-medium text-gray-900">{{ $item['total_sold'] ?? 0 }} sold</p>
                                    </div>
                                    <p class="text-sm text-gray-500">{{ $item['product']->formattedPrice ?? 'Price Not Available' }}</p>
                                </div>
                            </div>
                            @empty
