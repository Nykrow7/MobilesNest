                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{!! $order->statusBadge !!}</td>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10 bg-gray-200 rounded-md flex items-center justify-center">
                                    ...
                                    <img src="{{ asset('storage/' . $item['product']->primaryImage->path) }}" alt="{{ $item['product']->name }}" class="h-10 w-10 object-cover rounded-md">
                                    @else
                                ...
                                <div class="ml-4 flex-1">
                                    <div class="flex justify-between">
                                        ...
                                        <p class="text-sm font-medium text-gray-900">{{ $item['total_sold'] }} sold</p>
                                    </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 flex-1">
                                    <div class="flex justify-between">
                                        ...
                                        <p class="text-sm font-medium text-red-500">{{ $product->quantity }} left</p>
                                    </div>
